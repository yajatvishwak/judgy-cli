...
@click.command(
    name="code",
    help="analysis of the code of project",
)
@click.option(
    "--summary",
...
def code(summary, output_location, title, git_link, git_location):
    c = CodeAgent(
        summary=summary,
        git_link=git_link,
    ...
    write(output_location,title,output,"_code_implementation_scores.json")
